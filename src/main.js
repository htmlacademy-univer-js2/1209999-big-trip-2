import PointsApi from './api-service/points-api.js';
import DestinationsApi from './api-service/destinations-api.js';
import OffersApi from './api-service/offers-api.js';
...
const destinationsModel = new DestinationsModel(new DestinationsApi(SERVER_URL, AUTHORIZATION));
const pointsModel = new PointsModel(new PointsApi(SERVER_URL, AUTHORIZATION));
const offersModel = new OffersModel(new OffersApi(SERVER_URL, AUTHORIZATION));
